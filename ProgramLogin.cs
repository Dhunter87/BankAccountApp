    ...
    public class ProgramLogin
    {
        ...
        public static void loginAttempt()
        {
            ...
            for (int loginAttempts = 1; loginAttempts <= 3; loginAttempts++)
            {
                ...
                else if (string.Equals(userNameAttempt, UserProfile.UserName)||(string.Equals(userNameAttempt,ExampleProfile.UserName)))
                {
                    Console.WriteLine("Please enter your password or type \"quit\" to exit : ");
                    string passwordAttempt = Console.ReadLine();
                    if (string.Equals(passwordAttempt.ToLower(), "quit"))
                    {
                        break;
                    }
                    ...
                    else
                    {
                        ...
                        if (string.Equals(entry, "1"))
                        {
                            ...
                            if (string.Equals(firstname, UserProfile.FirstName)||(string.Equals(firstname, ExampleProfile.FirstName)))
                            {
                                Console.WriteLine("Please enter users last name: ");
                                string lastName = Console.ReadLine().Trim();
                                if (string.Equals(lastName, UserProfile.LastName)||(string.Equals(lastName, ExampleProfile.LastName)))
                                {
                                    Console.WriteLine("Please enter date of birth: ");
                                    string dateOfBirth = Console.ReadLine().Trim();
                                    if (string.Equals(dateOfBirth, UserProfile.DateOfBirth)||(string.Equals(dateOfBirth, ExampleProfile.DateOfBirth)))
                                    {
                                        Console.WriteLine("Please enter address: ");
                                        string address = Console.ReadLine().Trim();
                                        if (string.Equals(address, UserProfile.Address)||(string.Equals(address, ExampleProfile.Address)))
                                        {
                                            Console.WriteLine("Please enter phone number: ");
                                            string phoneNumber = Console.ReadLine().Trim();
                                            if (string.Equals(phoneNumber, UserProfile.PhoneNumber)||(string.Equals(phoneNumber, ExampleProfile.PhoneNumber)))
                                            {
